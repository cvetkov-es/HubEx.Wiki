...
Мобильное приложение **HubEx исполнитель** поддерживает увеличение размера шрифта: приложение считывает системные настройки масштаба текста вашего телефона (специальные возможности/accessibility в iOS и Android) и применяет их во всех ключевых разделах — списках и карточках **Заявок**, чатах, боковом меню, профиле, настройках, графике, уведомлениях и модальных окнах. Для сохранения аккуратного вида интерфейса предусмотрено техническое ограничение максимального увеличения; длинные названия в карточках, списках и на кнопках при этом обрезаются многоточием или переносятся на вторую строку.
...
* [Вход в мобильное приложение Заказчика и Сотрудника](EnterToMob.md);
* [Геолокация в мобильном приложении исполнителя](GEOinMob.md);
* [Создание заявки](https://wiki.hubex.ru/docs/FAQ/RU/user/CreatingTicket.html#mobticket).
