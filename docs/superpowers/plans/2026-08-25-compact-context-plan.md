...
Ярус 2 добавить строками. Номера `@sNN` ниже даны под раскладку, где заявки и их ЖЦ — s01–s03, объекты и их типы — s05–s06, компании — s08, роли и участки — s09, SLA и виды работ — s12, склад — s14, платформа — s21. **Если твоя раскладка иная — пересчитай ссылки под неё**: источники синтетического раздела обязаны покрывать всё, что он должен уметь сказать по спеку.
